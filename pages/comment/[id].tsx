          ...
          <div className='flex-1 flex flex-col gap-5'>
            <div className='flex flex-col ml-5 pt-12 pb-8 w-full mt-[2rem]'>
              ...
              <button
                ...
                className={
                  classNames({
                    'flex justify-center items-center font-semibold text-base text-darkGry w-[102px] h-[50px] rounded-full my-[49px]': true,
                    'bg-lightGrey w-[102px]': commentState?.isThunder === 0,
                    'bg-primary w-[125px]': commentState?.isThunder === 1
                  })
                }
                onClick={() => handleIsSpoiler(commentState?.isThunder ? 0 : 1)}
              >
                爆雷上標 <AiOutlineCheck className={classNames({
                  'invisible ml-[-15px]': commentState?.isThunder === 0,
                  'ml-2': commentState?.isThunder === 1
                })} />
              </button>
              <div className='flex border-t-2 border-r-2 border-gray-400 rounded-r-3xl rounded-b-none text-[#3E3E3E]leading-tight w-[943px] m-h-[500px]'>
                <textarea
                  // type='text'
